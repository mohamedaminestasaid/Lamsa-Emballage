...
const ProductListPage = () => {
  ...
  return (
    ...
    <div className='container sticky top-24 mx-auto grid grid-cols-[90px,1fr] md:grid-cols-[200px,1fr] lg:grid-cols-[270px,1fr]'>
      {/** Subcategory **/}
      <div className='min-h-[50vh] max-h-[88vh] overflow-y-scroll grid gap-1 shadow-md scrollbarCustom bg-white py-2'>
        {
          DisplaySubCatory
            .filter(s => s && s.category?.length > 0) // Ensure valid subcategory
            .map((s, index) => {
